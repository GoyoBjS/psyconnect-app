      ...
      <View style={styles.cardsContainer}>
        ...
        >
          ...
          <View style={{ marginRight: 84 }}>
            ...
            <Text style={styles.cardDescription}>
              Este tipo de registros es bueno para cuando tienes poco tiempo o
              paciencia para completar el registro completo.
            </Text>
            <Text style={styles.cardDescription}>
              Se recomienda actualizarlo más tarde para que la sesión sea más
              fructífera.
            </Text>
          </View>
        </Pressable>
        ...
        >
          ...
          <View style={{ marginLeft: 84 }}>
            ...
            <Text style={styles.cardDescription}>
              Este tipo de registros es bueno para cuando necesitas desahogarte
              y expresar lo que sientes.
            </Text>
            <Text style={styles.cardDescription}>
              También puedes usarlo para cuando el conflicto se ha resuelto y
              tienes tiempo para expresar todo lo sentido y ocurrido.
            </Text>
          </View>
        </Pressable>
      </View>
